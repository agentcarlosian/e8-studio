...
// future models such as tilings and quasicrystals remain outside this graph
// until they arrive as focused, tested features.
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        connections: [{ lessonId: 'coxeter-plane', label: 'Scale the reflection idea from rank 2 to E8' }, { lessonId: 'reading-dynkin', label: 'Compress simple-root relations into diagrams' }],
      },
      {
        id: 'coxeter-plane', title: 'The Coxeter plane', view: 'e8coxeter', estimatedMinutes: 8, prerequisites: ['rank-two-reflections'],
