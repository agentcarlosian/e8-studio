...
export const GALLERY_PRESETS = [
  ...
  { id: 'milky-meditation', name: 'Milky Meditation', settings: { view: 'bloom', shape: 'icosahedron', palette: 'rose_gold', bgMode: 'milkyway', bgIntensity: 0.8, bloomAmount: 0.4, bloomAuto: true, fxMode: 'fog', fxIntensity: 0.4, autoRotate: true, rotationSpeed: 0.002 } },
  { id: 'living-e8', name: 'Living E8', description: 'A breathing SDF projection in vivid mathematical prime colors.', featured: true, settings: { view: 'raymarched', palette: 'prime', bgMode: 'quantum', bgIntensity: 0.72, e8MorphT: 0.35, autoSliders: ['e8MorphT'], sdfBloom: 0.72, sdfEdges: 0.42, sdfAniso: 0.68, fxMode: 'aura', fxIntensity: 0.32, cameraOrbit: true, cameraPath: 'manual' } },
  { id: 'opal-flux', name: 'Opal Flux', description: 'Soft iridescence moving across an extruded E8 field.', featured: true, settings: { view: 'raymarched', palette: 'opal', bgMode: 'frost', bgIntensity: 0.58, e8MorphT: 0.62, autoSliders: ['e8MorphT'], sdfBloom: 0.5, sdfEdges: 0.62, sdfAniso: 0.85, fxMode: 'iridescent', fxIntensity: 0.38, cameraOrbit: true } },
  { id: 'solar-lattice', name: 'Solar Lattice', description: 'A hot Coxeter lattice edged like a small artificial sun.', featured: true, settings: { view: 'e8coxeter', e8ViewMode: 'coxeter', palette: 'solar_flare', bgMode: 'ember', bgIntensity: 0.62, showRings: true, showPetrie: true, showEdges: true, rootDiffusion: true, fxMode: 'edge-glow', fxIntensity: 0.42, cameraPath: 'coxeterOrbit' } },
  ...
  { id: 'rose-crystal', name: 'Rose Crystal', description: 'A slow crystalline bloom with warm metallic highlights.', settings: { view: 'platonic', shape: 'great_icosahedron', palette: 'rose_gold', bgMode: 'milkyway', bgIntensity: 0.62, autoRotate: true, rotationSpeed: 0.0025, fxMode: 'crystal', fxIntensity: 0.46 } },
...
export function createGalleryBaseline() {
  return {
    ...
    bgMode: 'void', bgIntensity: 0.7, fxMode: 'none', fxIntensity: 0.5,
