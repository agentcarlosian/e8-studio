...
export const GALLERY_PRESETS = [
  ...
  { id: 'tron-grid', name: 'Tidal Geometry', description: 'An orthographic E8 projection suspended over refracted turquoise light.', settings: { view: 'e8coxeter', e8ViewMode: 'ortho3d', palette: 'electric', bgMode: 'tide', bgIntensity: 0.85, autoRotate: true, fxMode: 'wireframe', fxIntensity: 0.5, showRings: true, showPetrie: true } },
  ...
  { id: 'multigrid-blueprint', name: 'Multigrid Blueprint', description: 'The hidden parallel-line construction revealed beneath an A2 lozenge lattice.', settings: { view: 'tiling', tilingSystem: 'A2', tilingDensity: 6, tilingRelief: 0.03, tilingShowTiles: true, tilingShowEdges: true, tilingShowGrid: true, tilingShowRoots: false, tilingShowVertices: false, tilingAnimate: false, palette: 'electric', bgMode: 'tide', bgIntensity: 0.72, fxMode: 'edge-glow', fxIntensity: 0.3, cameraOrbit: false } },
];
