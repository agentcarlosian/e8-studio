...
def main() -> int:
    ...
    try:
        with sync_playwright() as p:
            ...
            check("E8 Coxeter zoom passes the former 320% cap", e8_zoom_past_old_cap["state"]["zoom"] > 3.2 and e8_zoom_past_old_cap["sliderMax"] == 15 and e8_zoom_past_old_cap["viewOutput"] == e8_zoom_past_old_cap["motionOutput"], str(e8_zoom_past_old_cap))
            page.get_by_role("button", name="Motion", exact=True).click()
            page.locator("#camera-zoom").fill("15")
            ...
            check("E8 Coxeter close inspection reaches 1500%", e8_max_zoom["state"]["zoom"] == 15 and e8_max_zoom["viewOutput"] == "1500%" and e8_max_zoom["motionOutput"] == "1500%", str(e8_max_zoom))
