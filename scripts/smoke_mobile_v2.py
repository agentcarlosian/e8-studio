...
def main() -> int:
    ...
    try:
        with sync_playwright() as p:
            ...
            check("Rainbow Ripple reproduces the complete desktop E8 neighbour graph", ripple_reference["edgeToggleExists"] and ripple_reference["edgeToggleChecked"] and ripple_reference["state"]["showEdges"] and ripple_reference["state"]["palette"] == "rainbow" and ripple_stats["fxRenderer"] == "geometry-ripple" and ripple_stats["e8ChordEdges"] == 6720 and ripple_reference["metrics"]["e8ChordEdgeCount"] == 6720 and ripple_reference["metrics"]["e8ChordDegreeMin"] == 56 and ripple_reference["metrics"]["e8ChordDegreeMax"] == 56 and ripple_stats["rippleEdgeSegments"] == ripple_stats["e8ChordEdges"] and ripple_stats["rippleColorBands"] >= 10 and ripple_stats["rippleBrightnessBands"] == 5 and ripple_stats["ripplePointCount"] == 240 and not ripple_stats["fxOverlayApplied"] and ripple_reference["backgroundFilter"] == "none", str(ripple_reference))
