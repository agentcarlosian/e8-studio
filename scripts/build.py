...
JS_FILES    = [
    ...
    ROOT / 'src' / 'fx' / 'background-shaders.js',
    ROOT / 'src' / 'fx' / 'quantum-orbitals.js',
    ...
    ROOT / 'src' / 'services' / 'model-files.js',
    ROOT / 'src' / 'services' / 'print-mesh.js',
    ROOT / 'src' / 'services' / 'print-files.js',
    ROOT / 'src' / 'ui' / 'model-export.js',
